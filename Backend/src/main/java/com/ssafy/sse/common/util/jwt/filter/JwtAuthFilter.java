...
import com.ssafy.sse.dto.SecurityUserDto;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    private final UserRespository memberRepository;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        String atc = request.getHeader("accessToken");
        ...
        if (jwtUtil.verifyToken(atc)) {
            ...
            User findMember = memberRepository.findByEmail(jwtUtil.getUid(atc))
                    .orElseThrow(IllegalStateException::new);

            // SecurityContext에 등록할 User 객체를 만들어준다.
            SecurityUserDto userDto = SecurityUserDto.builder()
                    .memberNo(findMember.getUserId())
